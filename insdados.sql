...
insert into cursos values(nextval('seq_curso'),'Engenharia Informatica');
insert into cursos values(nextval('seq_curso'),'Engenharia Electrotecnica');
insert into cursos values(nextval('seq_curso'),'Engenharia do Ambiente');
insert into cursos values(nextval('seq_curso'),'Matematica');
insert into cursos values(nextval('seq_curso'),'Arquitectura');

/* Tabela alunos */
/* num_aluno, nome, local, data_nsc, sexo, cod_curso */

insert into alunos values(nextval('seq_aluno'),'Joaquim Pires Lopes','Lisboa',to_date('1992.01.01','YYYY.MM.DD'),'M',2);
insert into alunos values(nextval('seq_aluno'),'Ana Maria Fonseca','Setubal',to_date('1992.03.01','YYYY.MM.DD'),'F',1);
insert into alunos values(nextval('seq_aluno'),'Paula Antunes','Lisboa',to_date('1991.07.13','YYYY.MM.DD'),'F',2);
insert into alunos values(nextval('seq_aluno'),'Joana Ramalho Silva','Costa da Caparica',to_date('1991.09.23','YYYY.MM.DD'),'F',3);
insert into alunos values(nextval('seq_aluno'),'Rui Manuel Silva','Cascais',to_date('1991.08.15','YYYY.MM.DD'),'M',1);
insert into alunos values(nextval('seq_aluno'),'Joao Paulo Santos','Lisboa',to_date('1992.11.16','YYYY.MM.DD'),'M',1);
insert into alunos values(nextval('seq_aluno'),'Cristina Fernandes Lopes','Lisboa',to_date('1992.01.07','YYYY.MM.DD'),'F',1);
insert into alunos values(nextval('seq_aluno'),'Miguel Pinto Leite','Cascais',to_date('1992.01.07','YYYY.MM.DD'),'M',3);
insert into alunos values(nextval('seq_aluno'),'Francisco Costa Rosa',NULL,to_date('1990.02.16','YYYY.MM.DD'),'M',4);
insert into alunos values(nextval('seq_aluno'),'Elsa Fialho Pinto',NULL,to_date('1989.10.29','YYYY.MM.DD'),'F',1);
insert into alunos values(nextval('seq_aluno'),'Maria Pinto Ribeiro',NULL,to_date('1993.10.20','YYYY.MM.DD'),'F',1);

/* Tabela departamentos */
/* cod_departamento, nome */

insert into departamentos values( nextval('seq_departamento'),
...
insert into cadeiras values(nextval('seq_cadeira'),'Introducao a Programacao',4,1);
insert into cadeiras values(nextval('seq_cadeira'),'Inteligencia Artificial',4,1);
insert into cadeiras values(nextval('seq_cadeira'),'Redes de Computadores',4,1);
insert into cadeiras values(nextval('seq_cadeira'),'Bases de Dados',4,1);
insert into cadeiras values(nextval('seq_cadeira'),'Sistemas de Bases de Dados',3,1);
insert into cadeiras values(nextval('seq_cadeira'),'Metodologias Desenvolvimento de Software',4,1);
insert into cadeiras values(nextval('seq_cadeira'),'Sistemas Distribuidos',4,1);
insert into cadeiras values(nextval('seq_cadeira'),'Sistemas Logicos',4,2);
insert into cadeiras values(nextval('seq_cadeira'),'Microprocessadores',4,2);
insert into cadeiras values(nextval('seq_cadeira'),'Electronica Geral',3,2);
insert into cadeiras values(nextval('seq_cadeira'),'Analise Matematica 1',4,3);
insert into cadeiras values(nextval('seq_cadeira'),'Calculo Numerico',3,3);
insert into cadeiras values(nextval('seq_cadeira'),'Analise Matematica 2',5,3);
insert into cadeiras values(nextval('seq_cadeira'),'Climatologia',4,4);
insert into cadeiras values(nextval('seq_cadeira'),'Poluicao do Ar',2,4);

/* Tabela categorias */
/* cod_categoria, nome, vencimento */

insert into categorias values(nextval('seq_categoria'),'Assistente',2071);
insert into categorias values(nextval('seq_categoria'),
                 'Professor Auxiliar',2885);
insert into categorias values(nextval('seq_categoria'),'Professor Associado',3255);
insert into categorias values(nextval('seq_categoria'),'Professor Catedratico',4217);

/* Tabela docentes */
/* cod_docente, nome, cod_departamento, cod_categoria */

insert into docentes values(nextval('seq_docente'),'Joana Ramalho Silva',1,1);
insert into docentes values(nextval('seq_docente'),'Filipe Costa Rocha',2,1);
insert into docentes values(nextval('seq_docente'),'Joao Mario Cunha',1,3);
insert into docentes values(nextval('seq_docente'),'Carla Maria Vargas',3,2);
insert into docentes values(nextval('seq_docente'),'Antonio Miguel Horta',3,3);
insert into docentes values(nextval('seq_docente'),'Eduardo Jose Durao',2,1);
insert into docentes values(nextval('seq_docente'),'Manuela Bravo Neves',1,2);
insert into docentes values(nextval('seq_docente'),'Sofia Alves Prazeres',1,3);
insert into docentes values(nextval('seq_docente'),'Joana Alves Pereira',4,2);
